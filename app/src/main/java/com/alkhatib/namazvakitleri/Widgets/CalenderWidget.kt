 ...
 */
class CalenderWidget : AppWidgetProvider() {
...
internal fun updateAppWidget2(
    ...
    val views = RemoteViews(context.packageName, R.layout.calender_widget)
    views.setTextViewText(R.id.calenderWidget, widgetText)
